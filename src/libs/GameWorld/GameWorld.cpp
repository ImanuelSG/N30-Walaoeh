...
void GameWorld::startGame()
{
    ...
    cout << endl;
    countdown(3);
    cout << BOLD << YELLOW << "Game dimulai!" << RESET << endl;
    cout << endl;

    while (!ended)
    {
        CommandManager.setIsTakingTurn(true);
        cout << BOLD << YELLOW << "Sekarang giliran " << listOfPLayers[currPlayerIndex]->getName() << " untuk melakukan aksi." << RESET << endl;
        cout << endl;
...
|  $$$$$$/|  $$$$$$/| $$ \  $$|  $$$$$$/| $$  | $$| $$  | $$   | $$   |  $$$$$$/| $$$$$$$$| $$  | $$   | $$    /$$$$$$|  $$$$$$/| $$ \  $$|  $$$$$$/
 \______/  \______/ |__/  \__/ \______/ |__/  |__/|__/  |__/   |__/    \______/ |________/|__/  |__/   |__/   |______/ \______/ |__/  \__/ \______/ 
        ...
        cout << BOLD << "Player " << currPlayer->getName() << " wins!" << RESET << endl;
